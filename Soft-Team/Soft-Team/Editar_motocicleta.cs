...
namespace Soft_Team
{
    public partial class Editar_motocicleta : Form
    {
        public Editar_motocicleta()
        {
            InitializeComponent();
        }
        ...
        private void Editar_motocicleta_Load(object sender, EventArgs e)
        {
        ...
        private void estadoComboBox_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            e.Handled = true;
        }
