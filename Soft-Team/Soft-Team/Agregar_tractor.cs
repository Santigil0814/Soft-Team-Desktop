...
namespace Soft_Team
{
    public partial class Agregar_tractor : Form
    {
        public Agregar_tractor()
        {
            InitializeComponent();
        }
        ...
        private void Agregar_tractor_Load(object sender, EventArgs e)
        {
        ...
        private void tipo_maquinaComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void horas_KmComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
